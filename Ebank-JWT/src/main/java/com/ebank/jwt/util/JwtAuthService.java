...
import com.ebank.jwt.system.kafka.KafkaListener;
...
public class JwtAuthService {
    private final static Logger logger = LoggerFactory.getLogger(JwtAuthService.class);
    ...
    public String login(String username,
        ...
        try {
            ...
            logger.info("{} login successfully, start generate token...",username);
    ...
    public String refreshToken(String oldToken){
        if(!jwtTokenUtil.isTokenExpired(oldToken)){
            logger.info("Refresh the old token ...");
