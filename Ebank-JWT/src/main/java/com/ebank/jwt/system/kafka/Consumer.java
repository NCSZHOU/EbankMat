...
public class Consumer {
    ...
    public TransactionPage fetchConsumerData() {
        logger.info("Start getting the data from Kafka server ...");
        ...
        logger.info("end of the fetch data from Kafka, this page credit：{} and debit:{},transaction size:{}",credit,debit,list.size());
        return transactionPage;
    }
    private String handleJsonString(String str) {
        /*
            handle the case JSON String like \"{\"A\":\"a\"}\"
         */
